    ...
    def get_timestamps_examples(self, interval: Interval) -> list[tuple[str, str, list[str]]]:
        ...
        if interval == Interval.W1: return [
            ('2025-02-28 16:00:00', '2025-05-02 16:00:00', [
                ...
                '2025-04-04 16:00:00', '2025-04-11 16:00:00', '2025-04-17 16:00:00', '2025-04-25 16:00:00',
                '2025-05-02 16:00:00'
            ])
        ]
        if interval == Interval.D1: return [
            ('2025-02-16 00:00:00', '2025-02-19 15:30:00', ['2025-02-18 16:00:00']),
            ('2024-03-08 14:30:00', '2024-03-12 10:30:00', ['2024-03-08 16:00:00', '2024-03-11 16:00:00'])
        ]
        if interval == Interval.H1: return [
            ('2025-02-16 00:00:00', '2025-02-19 15:30:00', [
                '2025-02-18 10:30:00', '2025-02-18 11:30:00', '2025-02-18 12:30:00', '2025-02-18 13:30:00',
                '2025-02-18 14:30:00', '2025-02-18 15:30:00', '2025-02-18 16:00:00', '2025-02-19 10:30:00',
                '2025-02-19 11:30:00', '2025-02-19 12:30:00', '2025-02-19 13:30:00', '2025-02-19 14:30:00',
                '2025-02-19 15:30:00'
            ]),
            ('2024-03-08 14:30:00', '2024-03-12 10:30:00', [
                '2024-03-08 15:30:00', '2024-03-08 16:00:00', '2024-03-11 10:30:00', '2024-03-11 11:30:00',
                '2024-03-11 12:30:00', '2024-03-11 13:30:00', '2024-03-11 14:30:00', '2024-03-11 15:30:00',
                '2024-03-11 16:00:00', '2024-03-12 10:30:00'
            ])
        ]
        if interval == Interval.M15: return [
