...
class TestQuery(unittest.TestCase):
    ...
    def test_pricing_l1(self):
        prices, volume, low, high, open, times = yahoo.get_pricing(
            'nvda',
            XNAS.str_to_unix("2021-11-26 16:00:00"),
            XNAS.str_to_unix("2023-05-13 16:00:00"),
            Interval.L1,
    ...
    def test_pricing_w1(self):
        prices, volume, low, high, open, times = yahoo.get_pricing(
            'nvda',
            XNAS.str_to_unix("2021-11-26 16:00:00"),
            XNAS.str_to_unix("2022-05-13 16:00:00"),
            Interval.W1,
            return_quotes=['close', 'volume', 'low', 'open', 'high', 'timestamp'],
            skip_cache=config.test.skip_cache
        )
    ...
    def test_pricing_d1(self):
        prices, volume, low, high, open, times = yahoo.get_pricing(
            'nvda',
            XNAS.str_to_unix("2021-11-30 16:00:00"),
            XNAS.str_to_unix("2022-01-14 16:00:00"),
            Interval.D1,
            return_quotes=['close', 'volume', 'low', 'open', 'high', 'timestamp'],
            skip_cache=config.test.skip_cache
        )
        self.assertEqual(XNAS.str_to_unix('2021-12-01 16:00:00'), times[0])
        self.assertEqual(XNAS.str_to_unix('2022-01-14 16:00:00'), times[-1])
        self.assertTrue(prices and volume and low and high and open and times)
    ...
    def test_pricing_h1(self):
        prices, volume, low, high, open, times = yahoo.get_pricing(
            'nvda',
            XNAS.str_to_unix("2023-12-01 00:00:00"),
            XNAS.str_to_unix("2024-01-15 00:00:00"),
            Interval.H1,
            return_quotes=['close', 'volume', 'low', 'high', 'open', 'timestamp'],
            skip_cache=config.test.skip_cache
        )
        self.assertEqual(XNAS.str_to_unix('2023-12-01 10:30:00'), times[0])
        self.assertEqual(XNAS.str_to_unix('2024-01-12 16:00:00'), times[-1])
    ...
    def test_pricing_m15(self):
        prices, volume, low, high, open, times = yahoo.get_pricing(
            'nvda',
            XNAS.str_to_unix("2025-02-10 16:00:00"),
            XNAS.str_to_unix("2025-02-12 16:00:00"),
            Interval.M15,
            return_quotes=['close', 'volume', 'low', 'open', 'high', 'timestamp'],
            skip_cache=config.test.skip_cache
        )
    ...
    def test_pricing_m5(self):
        prices, volume, low, high, open, times = yahoo.get_pricing(
            'nvda',
            XNAS.str_to_unix("2025-02-11 15:00:00"),
            XNAS.str_to_unix("2025-02-12 10:00:00"),
            Interval.M5,
            return_quotes=['close', 'volume', 'low', 'open', 'high', 'timestamp'],
            skip_cache=config.test.skip_cache
        )
